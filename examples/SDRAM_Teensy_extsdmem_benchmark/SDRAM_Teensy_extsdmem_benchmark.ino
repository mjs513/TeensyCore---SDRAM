...
/************************************************************************/
EXTSDMEM uint8_t buffer8[4096];
EXTSDMEM uint16_t buffer16[4096];
EXTSDMEM uint32_t buffer32[4096];

#define PRINTF  Serial.printf
#define EXAMPLE_SEMC_START_ADDRESS 0x80000000
...
void SEMC_SDRAMReadWrite32Bit(void)
{
    ...
    for (index = 0; index < datalen; index++)
    {
        ...
        buffer32[index] = sdram_writeBuffer[index];
    }
    ...
    for (index = 0; index < datalen; index++)
    {
        sdram_readBuffer[index] = buffer32[index];
    }
...
static void SEMC_SDRAMReadWrite16Bit(void)
{
    ...
    for (index = 0; index < datalen; index++)
    {
        ...
        buffer16[index] = sdram_writeBuffer[index];
    }
    ...
    for (index = 0; index < datalen; index++)
    {
        sdram_readBuffer[index] = buffer16[index];
    }
...
static void SEMC_SDRAMReadWrite8Bit(void)
{
    ...
    for (index = 0; index < datalen; index++)
    {
        ...
        buffer8[index] = sdram_writeBuffer[index];
    }
    ...
    for (index = 0; index < datalen; index++)
    {
        sdram_readBuffer[index] = buffer8[index];
    }
